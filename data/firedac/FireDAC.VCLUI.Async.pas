...
{$I FireDAC.inc}
{$IFDEF WIN32}
  {$HPPEMIT '#pragma link "FireDAC.VCLUI.Async.obj"'}
{$ELSE}
  {$HPPEMIT '#pragma link "FireDAC.VCLUI.Async.o"'}
{$ENDIF}
...
initialization
  oFact := TFDSingletonFactory.Create(TFDGUIxFormsAsyncExecuteImpl,
    IFDGUIxAsyncExecuteDialog, C_FD_GUIxFormsProvider, 'FireDAC.VCLUI.Async');
