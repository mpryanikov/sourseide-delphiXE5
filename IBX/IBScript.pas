...
uses
  System.Classes, IBDatabase, IBCustomDataset, IBSQL, IBDatabaseInfo,
  IBExternals;
...
uses System.SysUtils, IBUtils, IB, IBXConst, IBIntf, System.Character;
          ...
          begin
            ...
            try
              if Assigned(Encoding) then
                ...
                bt := TEncoding.ANSI.GetBytes(SQLText + #0);
