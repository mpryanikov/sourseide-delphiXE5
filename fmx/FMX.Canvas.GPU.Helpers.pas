...
uses
  System.Math, System.Generics.Collections, FMX.Consts, FMX.PixelFormats;
...
begin
  ...
  if Assigned(FCurrentTexture) and Assigned(FContext) and (TTextureStyle.tsRenderTarget in FCurrentTexture.Style) and
...
var
  ...
  var
    I: Integer;
  begin
    UpdateBatchingStatus(btTriangles, CurVertices.Count, CurIndices.Count, nil, nil);
