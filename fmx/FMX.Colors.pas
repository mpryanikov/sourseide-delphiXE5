...
uses
  ...
  FMX.Edit, FMX.ListBox, FMX.PixelFormats, FMX.Controls, FMX.Pickers, FMX.Graphics;
...
begin
  ...
  FColorBox.Align := TAlignLayout.alHorzCenter;
  ...
  FColorPanel.Align := TAlignLayout.alLeft;
...
var
  W, LWidth: Single;
begin
  TCanvasManager.MeasureCanvas.Font.Assign(FColorText.LastTextSettings.Font);
  W := Max(FColorText.Width, Ceil(TCanvasManager.MeasureCanvas.TextWidth('#DDDDDDDD')) + 6);
  FColorText.Width := W;
