...
{$ENDIF }
  ...
  processor_cpu_load_info = record
    cpu_ticks: array[0..CPU_STATE_MAX-1] of LongWord;
  end;
...
function host_info(host: host_t;
                   ...
                   out host_info_out: host_info_t;
                   out host_info_outCnt: mach_msg_type_number_t): kern_return_t; cdecl
