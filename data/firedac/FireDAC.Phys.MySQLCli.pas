...
type
  ...
  my_ppchar     = ^my_pchar;
  my_ulong      = TFDULongInt;
  my_long       = TFDLongInt;
  my_size_t     = {$IFDEF FireDAC_64} UInt64 {$ELSE} LongWord {$ENDIF};
  Pmy_ulong     = ^my_ulong;
  Pmy_long      = ^my_long;
...
{>= 5.0.6 end}
  ...
  MYSQL_BIND0510 = record
    ...
    pack_length: LongWord;	        // Internal length for data
...
type
  ...
  TPrcmysql_num_fields = function(res: PMYSQL_RES): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_field_tell = function(res: PMYSQL_RES): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};

  TPrcmysql_field_count = function(mysql: PMYSQL): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_errno = function(mysql: PMYSQL): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_warning_count = function(mysql: PMYSQL): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_real_connect = function(mysql: PMYSQL; const host, user, passwd, db: my_pchar;
    port: LongWord; const unix_socket: my_pchar; clientflag: my_ulong): PMYSQL; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_refresh = function(mysql: PMYSQL; refresh_options: LongWord): Integer; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_stmt_fetch_column = function(stmt: PMYSQL_STMT; bind: PMYSQL_BIND;
    column: LongWord; offset: my_ulong): Integer; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_stmt_errno = function(stmt: PMYSQL_STMT): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  TPrcmysql_stmt_field_count = function (stmt: PMYSQL_STMT): LongWord; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
