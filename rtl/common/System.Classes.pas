...
{$IFNDEF NEXTGEN}
//    procedure Read(Buffer: pointer; Count: Longint); overload;
...
{$IFNDEF NEXTGEN}
//    procedure Write(const Buffer: Pointer; Count: Longint); overload;
...
{$ENDIF POSIX}
  System.Variants,
  System.Rtti, System.Character, System.RTLConsts, System.SysConst;
...
function TStream.ReadData(const Buffer: TBytes; Count: Longint): Longint;
begin
  Result := Read(Buffer, 0, Count);
end;

function TStream.ReadData(var Buffer: Boolean): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 1);
...
function TStream.ReadData(var Buffer: Boolean; Count: Longint): Longint;
var
  Buf: TBytes;
begin
  if Count <> 0 then
...
{$IFNDEF NEXTGEN}
function TStream.ReadData(var Buffer: AnsiChar): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 2);
...
function TStream.ReadData(var Buffer: AnsiChar; Count: Longint): Longint;
var
  Buf: TBytes;
begin
  if Count <> 0 then
...
function TStream.ReadData(var Buffer: Char): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 2);
...
function TStream.ReadData(var Buffer: Char; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: Int8): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 1);
...
function TStream.ReadData(var Buffer: Int8; Count: Longint): Longint;
var
  Buf: TBytes;
begin
  if Count <> 0 then
...
function TStream.ReadData(var Buffer: UInt8): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 1);
...
function TStream.ReadData(var Buffer: UInt8; Count: Longint): Longint;
var
  Buf: TBytes;
begin
  if Count <> 0 then
...
function TStream.ReadData(var Buffer: Int16): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 2);
  Result := Read(Buf, 2);
  Buffer := Int16(Buf[0] or (Buf[1] shl 8));
end;

function TStream.ReadData(var Buffer: Int16; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: UInt16): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 2);
  Result := Read(Buf, 2);
  Buffer := UInt16(Buf[0] or (Buf[1] shl 8));
end;

function TStream.ReadData(var Buffer: UInt16; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: Int32): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 4);
  Result := Read(Buf, 0, 4);
  Buffer := Int32(Buf[0] or (Buf[1] shl 8) or (Buf[2] shl 16) or (Buf[3] shl 24));
end;

function TStream.ReadData(var Buffer: Int32; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: UInt32): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 4);
  Result := Read(Buf, 0, 4);
  Buffer := UInt32(Buf[0] or (Buf[1] shl 8) or (Buf[2] shl 16) or (Buf[3] shl 24));
end;

function TStream.ReadData(var Buffer: UInt32; Count: Longint): Longint;
var
  Buf: TBytes;
  S: UInt32;
begin
...
function TStream.ReadData(var Buffer: Int64): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 8);
...
function TStream.ReadData(var Buffer: Int64; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: UInt64): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 8);
...
function TStream.ReadData(var Buffer: UInt64; Count: Longint): Longint;
var
  Buf: TBytes;
  S: Integer;
begin
...
function TStream.ReadData(var Buffer: Single): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.ReadData(var Buffer: Single; Count: Longint): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.ReadData(var Buffer: Double): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.ReadData(var Buffer: Double; Count: Longint): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.ReadData(var Buffer: Extended): Longint;
const
...
begin
  ...
  Result := Read(Buf, BufSize);
//  Buffer := BitConverter.ToSingle(Buf, 0);
  for I := 0 to BufSize - 1 do
    Buffer.Bytes[I] := Buf[I];
end;

function TStream.ReadData(var Buffer: Extended; Count: Longint): Longint;
const
  BufSize = SizeOf(Extended);
var
  Buf: TBytes;
...
function TStream.ReadData(var Buffer: TExtended80Rec): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.ReadData(var Buffer: TExtended80Rec; Count: Longint): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
...
function TStream.WriteData(const Buffer: TBytes; Count: Longint): Longint;
begin
  Result := Write(Buffer, 0, Count);
end;

function TStream.WriteData(const Buffer: Pointer; Count: Longint): Longint;
begin
  Result := Write(Buffer, Count);
end;

function TStream.WriteData(const Buffer: Boolean): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 1);
  Buf[0] := Byte(Buffer);
  Result := Write(Buf, 0, 1);
end;

function TStream.WriteData(const Buffer: Boolean; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
{$IFNDEF NEXTGEN}
function TStream.WriteData(const Buffer: AnsiChar): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 1);
...
function TStream.WriteData(const Buffer: AnsiChar; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Char): Longint;
var
  Buf: TBytes;
begin
  SetLength(Buf, 2);
...
function TStream.WriteData(const Buffer: Char; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Int8): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 1);
...
function TStream.WriteData(const Buffer: Int8; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: UInt8): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 1);
...
function TStream.WriteData(const Buffer: UInt8; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Int16): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 2);
...
function TStream.WriteData(const Buffer: Int16; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: UInt16): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 2);
...
function TStream.WriteData(const Buffer: UInt16; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Int32): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 4);
...
function TStream.WriteData(const Buffer: UInt32): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 4);
...
function TStream.WriteData(const Buffer: UInt32; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Int64): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 8);
  ...
  Buf[2] := (Buffer shr 16) and $FF;
  Buf[3] := (Buffer shr 24) and $FF;
  Buf[4] := (Buffer shr 32) and $FF;
  Buf[5] := (Buffer shr 40) and $FF;
  Buf[6] := (Buffer shr 48) and $FF;
  Buf[7] := (Buffer shr 56) and $FF;
  Result := Write(Buf, 0, 8);
end;

function TStream.WriteData(const Buffer: Int64; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: UInt64): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 8);
...
function TStream.WriteData(const Buffer: UInt64; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Single): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 4);
  Buf[0] := Buffer.Bytes[0];
  Buf[1] := Buffer.Bytes[1];
  Buf[2] := Buffer.Bytes[2];
  Buf[3] := Buffer.Bytes[3];
  Result := Write(Buf, 0, 4);
end;

function TStream.WriteData(const Buffer: Single; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Double): Longint;
var
  Buf: TBytes;
begin
  Setlength(Buf, 8);
  ...
  Buf[2] := Buffer.Bytes[2];
  Buf[3] := Buffer.Bytes[3];
  Buf[4] := Buffer.Bytes[4];
  Buf[5] := Buffer.Bytes[5];
  Buf[6] := Buffer.Bytes[6];
  Buf[7] := Buffer.Bytes[7];
  Result := Write(Buf, 0, 8);
end;

function TStream.WriteData(const Buffer: Double; Count: Longint): Longint;
var
  Buf: TBytes;
  C: Integer;
begin
...
function TStream.WriteData(const Buffer: Extended): Longint;
const
  BufSize = SizeOf(Extended);
var
  Buf: TBytes;
...
begin
  ...
  Result := Write(Buf, 0, BufSize);
end;

function TStream.WriteData(const Buffer: Extended; Count: Longint): Longint;
const
  BufSize = SizeOf(Extended);
var
  Buf: TBytes;
...
function TStream.WriteData(const Buffer: TExtended80Rec): Longint;
var
  Buf: TBytes;
  I: Integer;
begin
  ...
  for I := 0 to 9 do
    Buf[I] := Buffer.Bytes[I];
  Result := Write(Buf, 0, 10);
end;

function TStream.WriteData(const Buffer: TExtended80Rec; Count: Longint): Longint;
var
  Buf: TBytes;
  I, C: Integer;
begin
...
procedure TStream.ReadBuffer(var Buffer: TBytes; Count: Longint);
begin
  ReadBuffer(Buffer, 0, Count);
end;

procedure TStream.ReadBuffer(var Buffer: TBytes; Offset, Count: Longint);
var
  LTotalCount,
  LReadCount: Longint;
begin
...
procedure TStream.ReadBufferData(var Buffer: Boolean; Count: Longint);
begin
...
procedure TStream.ReadBufferData(var Buffer: AnsiChar; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Char; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Int8; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: UInt8; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Int16; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: UInt16; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Int32; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: UInt32; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Int64; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: UInt64; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Single; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Double; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: Extended; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.ReadBufferData(var Buffer: TExtended80Rec; Count: Longint);
begin
  if (Count <> 0) and (ReadData(Buffer, Count) <> Count) then
    raise EReadError.Create(SReadError);
end;
...
procedure TStream.WriteBuffer(const Buffer: TBytes; Offset, Count: Longint);
var
  LTotalCount,
  LWrittenCount: Longint;
begin
...
procedure TStream.WriteBufferData(var Buffer: Integer; Count: Longint);
var
  Buf: TBytes;
  C: Integer;
begin
...
procedure _MoveData(Source: TBytes; SrcIndex: NativeInt; Dest: TBytes; DestIndex: NativeInt; Count: NativeInt); overload;
var
  Ind: NativeInt;
begin
  Ind := 0;
...
procedure MoveData(Source: TBytes; SrcIndex: NativeInt; Dest: Pointer; DestIndex: NativeInt; Count: NativeInt); overload;
var
  Ind: NativeInt;
begin
  Ind := 0;
  while Count > 0 do
  begin
    PByteArray(Dest)^[DestIndex + Ind] := Source[SrcIndex + Ind];
    inc(Ind);
    dec(Count);
  end;
end;

procedure __MoveData(Source: TBytes; SrcIndex: NativeInt; Dest: Pointer; DestIndex: NativeInt; Count: NativeInt); overload;
var
  Ind: NativeInt;
begin
  Ind := 0;
...
procedure TReader.Read(var Buffer; Count: Longint);
var
  LShouldRead: Longint;
  BufOffset: LongInt;
begin
...
procedure TReader.Read(Buffer: TBytes; Offset, Count: Longint);
var
  LShouldRead: Longint;
begin
  while Count > 0 do
...
procedure TReader.Read(Buffer: TBytes; Count: Longint);
begin
  Read(Buffer, 0, Count);
end;
...
{$IFNDEF NEXTGEN}
procedure TReader.ReadVar(var Buffer: AnsiChar; Count: LongInt);
begin
  Buffer := #0;
  EnsureAtLeast(Count);
  if Count >= 1 then
...
procedure TReader.ReadVar(var Buffer: Char; Count: Longint);
begin
  Buffer := #0;
  EnsureAtLeast(Count);
  if Count = 1 then
...
procedure TReader.ReadVar(var Buffer: Int8; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count >= 1 then
...
procedure TReader.ReadVar(var Buffer: UInt8; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count >= 1 then
...
procedure TReader.ReadVar(var Buffer: Int16; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: UInt16; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: Int32; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: UInt32; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: Int64; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: UInt64; Count: Longint);
begin
  Buffer := 0;
  EnsureAtLeast(Count);
  if Count > 0 then
...
procedure TReader.ReadVar(var Buffer: Single; Count: Longint);
var
  ind: Integer;
begin
  Buffer := 0;
...
procedure TReader.ReadVar(var Buffer: Double; Count: Longint);
var
  ind: Integer;
begin
  Buffer := 0;
...
procedure TReader.ReadVar(var Buffer: Extended; Count: Longint);
const
  BufSize = SizeOf(Extended);
var
  ind: Integer;
...
procedure TReader.ReadVar(var Buffer: TExtended80Rec; Count: Longint);
var
  ind: Integer;
begin
  Buffer.BuildUp(False, 0, -$3FFF); // 0.0
...
procedure TWriter.Write(Buffer: TBytes; Offset, Count: Longint);
var
  P, C, S, I: Integer;
begin
  P := Offset;
...
procedure TWriter.Write(Buffer: TBytes; Count: Longint);
begin
...
procedure TWriter.WriteVar(const Buffer: AnsiChar; Count: LongInt);
begin
  EnsureAtLeast(1);
...
procedure TWriter.WriteVar(const Buffer: Char; Count: Longint);
begin
  EnsureAtLeast(2);
...
procedure TWriter.WriteVar(const Buffer: Int8; Count: Longint);
begin
  EnsureAtLeast(1);
...
procedure TWriter.WriteVar(const Buffer: UInt8; Count: Longint);
begin
  EnsureAtLeast(1);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: Int16; Count: Longint);
begin
  EnsureAtLeast(2);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: UInt16; Count: Longint);
begin
  EnsureAtLeast(2);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: Int32; Count: Longint);
begin
  EnsureAtLeast(4);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: UInt32; Count: Longint);
begin
  EnsureAtLeast(4);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: Int64; Count: Longint);
begin
  EnsureAtLeast(8);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: UInt64; Count: Longint);
begin
  EnsureAtLeast(8);
  FBuffer[FBufPos] := Byte(Buffer and $FF);
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: Single; Count: Longint);
begin
  EnsureAtLeast(4);
...
procedure TWriter.WriteVar(const Buffer: Double; Count: Longint);
begin
  EnsureAtLeast(8);
  FBuffer[FBufPos] := Buffer.Bytes[0];
  if Count > 1 then
...
procedure TWriter.WriteVar(const Buffer: Extended; Count: Longint);
begin
{$IFDEF EXTENDEDIS10BYTES}
...
procedure TWriter.WriteVar(const Buffer: TExtended80Rec; Count: Longint);
begin
  EnsureAtLeast(10);
  FBuffer[FBufPos] := Buffer.Bytes[0];
  if Count > 1 then
...
//    P := T.TypeData;
    ...
    while C1 > 0 do
    begin
      P := PByte( PPropInfo(P).Tail );
      Dec(C1);
    end;
    C1 := PWord(P)^; Inc(P,2);// PropDataEx.PropCount
    while C1 > 0 do
    begin
      if PPropInfoEx(P)^.Info.Name = PropInfo.Name then
      begin
...
var
  ...
  begin
    ...
    begin
      if GetDefaultAttribute(Temp) then
        ...
        Result := (PPropInfo(PropInfo)^.Default <> LongInt($80000000)) and (Value = 0);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        Default := PPropInfo(PropInfo)^.Default;
        Result := (Default <> LongInt($80000000)) and (Value = Int64(Default));
      end;
    end;
  end;
  ...
  begin
    ...
    begin
      if GetDefaultAttribute(Temp) then
        ...
        Result := (PPropInfo(PropInfo)^.Default <> LongInt($80000000)) and (Value = '');
    end;
  end;
  ...
  begin
    ...
    begin
      if GetDefaultAttribute(Temp) then
        ...
        Result := (PPropInfo(PropInfo)^.Default <> LongInt($80000000)) and VarIsClear(Value);
    end;
  end;
...
begin
  LExternalThreads := AtomicExchange(Pointer(ExternalThreads), nil);
...
begin
  Result := (Action <> nil) and (Action.HandlesTarget(Self));
  if Result then
