...
{ TWebDispatcherEditor }
  ...
  ///  <summary> Attach a request and response to a module
  ///  </summary>
  IWebModuleContext = interface
  ['{F2859B61-8311-4A19-918E-B968A43AC636}']
    procedure InitContext(Request: TWebRequest; Response: TWebResponse);
    procedure FinishContext;
  end;
...
{ TCustomWebDispatcher }
  ...
  TCustomWebDispatcher = class(TDataModule, IWebRequestHandler, IWebDispatchActions, IWebDispatcherAccess,
    IMultiModuleSupport, IWebExceptionHandler, IWebModuleContext)
  private
  ...
  protected
    ...
    function HandleRequest(Request: TWebRequest; Response: TWebResponse): Boolean;
    { IMultiModuleSupport }
    procedure InitMultiContext(Request: TWebRequest; Response: TWebResponse);
    procedure InitModule(AModule: TComponent);
    procedure FinishMultiContext;
    procedure IMultiModuleSupport.InitContext = InitContext;
    procedure IMultiModuleSupport.FinishContext = FinishContext;
    { IWebModuleContext }
    procedure InitContext(Request: TWebRequest; Response: TWebResponse);
    procedure FinishContext;
...
procedure TCustomWebDispatcher.FinishMultiContext;
begin
  //
end;
...
procedure TCustomWebDispatcher.InitMultiContext(Request: TWebRequest;
  Response: TWebResponse);
begin
  FRequest := Request;
  FResponse := Response;
