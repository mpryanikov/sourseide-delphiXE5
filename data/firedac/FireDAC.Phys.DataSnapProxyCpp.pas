...
{$I FireDAC.inc}
{$IFDEF WIN32}
  {$HPPEMIT '#pragma link "FireDAC.Phys.DataSnapProxyCpp.obj"'}
{$ELSE}
  {$HPPEMIT '#pragma link "FireDAC.Phys.DataSnapProxyCpp.o"'}
{$ENDIF}

unit FireDAC.Phys.DataSnapProxyCpp;
...
begin
  Result.UsesUnits := 'FireDAC.Phys.DataSnapProxyCpp';
