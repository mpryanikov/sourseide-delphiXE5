...
uses
  System.SysUtils, IBHeader, IBExternals, Data.DB, IBXConst, IBIntf;
...
procedure IBAlloc(var P; OldSize, NewSize: Integer); overload;
{$IFDEF NEXTGEN}
procedure IBAlloc(var p : TRecBuf; OldSize, NewSize: Integer); overload;
{$ELSE}
procedure IBAlloc(var p : TRecordBuffer; OldSize, NewSize: Integer); overload;
{$ENDIF NEXTGEN}
...
{$IFDEF NEXTGEN}
procedure IBAlloc(var p : TRecBuf; OldSize, NewSize: Integer);
var
  i: Integer;
begin
  ReallocMem(Pointer(p), NewSize);
