...
{-------------------------------------------------------------------------------}
function TFDPhysASAMetadata.InternalEscapeBoolean(
...
{-------------------------------------------------------------------------------}
function TFDPhysASACommandGenerator.GetPing: String;
begin
  Result := 'SELECT 1';
end;
...
var
  s: String;
begin
  if (FConnMeta.ServerVersion >= cvSybaseASA9) and (ASkip > 0) and
