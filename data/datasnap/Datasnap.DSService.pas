        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if (LBody is TJSONObject) and (TJSONObject(LBody).Size = 1) and
                (TJSONObject(LBody).Get(0).JSonString.Value = PARAMETERS_PAIR) and
                (TJSONObject(LBody).Get(0).JsonValue is TJSONArray) then
              begin
                LBodyArray := TJSONArray(TJSONObject(LBody).Get(0).JsonValue);
                LBodyArrayIndex := 0;
              end
            end;
          end;
          ...
          begin
            ...
            begin
              if LBodyArrayIndex < LBodyArray.Size  then
              begin
                LJSONParam := LBodyArray.Get(LBodyArrayIndex);
