...
{$I FireDAC.inc}
{$IFDEF WIN32}
  {$HPPEMIT '#pragma link "FireDAC.FMXUI.Async.obj"'}
{$ELSE}
  {$HPPEMIT '#pragma link "FireDAC.FMXUI.Async.o"'}
{$ENDIF}
...
initialization
  oFact := TFDSingletonFactory.Create(TFDGUIxFMXAsyncExecuteImpl,
    IFDGUIxAsyncExecuteDialog, C_FD_GUIxFMXProvider, 'FireDAC.FMXUI.Async');
