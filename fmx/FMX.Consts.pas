...
const
  ...
  GlobalDisableiOSGPUCanvas: string = 'GlobalDisableiOSGPUCanvas' deprecated 'Disabling GPU canvas will result in unpredictable behavior and is not officially supported.'; // do not localize
