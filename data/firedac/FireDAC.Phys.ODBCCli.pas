...
{$IFDEF FireDAC_64}
  ...
  SQLRowsetSize = UInt64;
{$ENDIF}
{$IFDEF FireDAC_32}
  SQLLen        = SQLInteger;
  SQLRowOffset  = SQLInteger;
  SQLRowCount   = SQLUInteger;
  SQLULen       = SQLUInteger;
  SQLTransID    = LongWord;
  SQLSetPosiRow = SQLUSmallint;
  SQLRowsetSize = SQLUInteger;
{$ENDIF}
  PSQLLen        = ^SQLLen;
...
type
  ...
  TSQLNumericRec = packed record
    precision: SQLByte;
    scale: SQLByte;
    sign: SQLByte; // 1 if positive, 0 if negative
