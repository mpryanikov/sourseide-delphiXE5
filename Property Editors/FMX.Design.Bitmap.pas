...
uses
  System.SysUtils, System.Classes, System.Types, System.UITypes, System.Math, FMX.Forms, FMX.Graphics,
...
begin
  ...
  begin
    ...
    if FCheckboardBitmap.Map(TMapAccess.maWrite, M) then
    try
...
procedure TBitmapDesigner.btnPasteClick(Sender: TObject);
begin
  // Clipboard
end;
