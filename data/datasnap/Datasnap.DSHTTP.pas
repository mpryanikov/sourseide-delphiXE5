...
type
  ...
  ///  <summary> REST command types processed by DataSnap
  ///  </summary>
  ///  <summary> Datasnap specific REST server.
  ///  </summary>
  TDSRESTServer = class
  public type
  ...
  ///    implementations for different command types.  Support REST and HTTP Tunnel.
  ///  </summary>
...
//    FSessionTimeout: Integer;
  ...
  ///  <summary> Datasnap Server REST service provider class.
  ///    Implements REST.
  ///  </summary>
  ...
  ///  <summary> Datasnap Server HTTP service provider class.
  ///    Provides lightweight http services for Datasnap technology. Implements
  ///    internet protocols such as REST and HTTP Tunnel.
  ///  </summary>
  ...
  ///  <summary>Singleton that will manage http applications</summary>
  TDSHTTPApplication = class
  public const
    // Context object names
    sSessionObject = 'session';
  private
    class var FInstance: TDSHTTPApplication;
  private
