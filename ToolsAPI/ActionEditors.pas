...
{$REGION 'The interaction of action with an IDE. This new code'}
  ...
  public
    ...
    class procedure RegisterImageLink(const ActionList: TContainedActionList;
                                      const ImageLink: TChangeLink); virtual;
    /// <summary>
...
begin
  if (Source is TContainedAction) and
     (Destination is TContainedAction) then
  begin
...
class procedure TIDEActions.RegisterImageLink(const ActionList: TContainedActionList;
                                              const ImageLink: TChangeLink);
begin

end;

class procedure TIDEActions.UnregisterImageLink(const ActionList: TContainedActionList;
                                                const ImageLink: TChangeLink);
begin
