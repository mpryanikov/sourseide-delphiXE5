...
{$ENDIF}
  TDBXRegistryKey               = '\Software\Embarcadero\BDS\12.0\dbExpress'; { Do not localize }
...
//      BlobSizeExact   = $10;
  ...
  /// <summary>TStringList with a dictionary to improve performance for managing key/value pairs.  This TStringList implementation
  /// does not support operations that change the location of a key in the list, such as Delete, Insert and Exchange</summary>
...
//    property BlobSizeExact: Boolean read IsBlobSizeExact;
  ...
  TDBXValue = class
    private
      // Note this eference can create an ARC cycle.  To break cycle, DisposeOf must be used
  ...
  begin
    ...
    begin
      ...
      try
        ...
        status := TMonitor.Wait(FEventSemaphore, INFINITE)
      finally
        TMonitor.Exit(FEventSemaphore);
      end;
    end;
