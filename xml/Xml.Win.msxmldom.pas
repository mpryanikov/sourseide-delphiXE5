...
{$IFDEF NEXTGEN}
function TMSDOMNode.selectNode(const nodePath: DomString): IDOMNode;
{$ELSE !NEXTGEN}
...
{$IFDEF NEXTGEN}
function TMSDOMNode.selectNodes(const nodePath: DomString): IDOMNodeList;
{$ELSE !NEXTGEN}
...
{$IFDEF NEXTGEN}
procedure TMSDOMNode.transformNode(const stylesheet: IDOMNode; var output: DomString);
{$ELSE !NEXTGEN}
