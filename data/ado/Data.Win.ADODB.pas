...
uses
  Winapi.Windows, System.Variants, Winapi.ActiveX, System.SysUtils, System.Classes,
  System.Generics.Collections, System.TypInfo, Data.DB, Winapi.OleDB, Winapi.ADOInt;
...
uses Data.DBCommon, Winapi.Mtx, Data.DBConsts, System.Win.ComObj, Data.Win.ADOConst,
  System.WideStrUtils, Data.FmtBcd, System.VarUtils, System.Types;
...
begin
  ...
  if (DataSet.Parameters.Count > 0) and Assigned(DataSet.MasterDataLink.DataSource) and
    Assigned(DataSet.MasterDataLink.DataSource.DataSet) then
  begin
    for I := 0 to DataSet.Parameters.Count - 1 do
      if (DataSet.Parameters[I].Direction in [pdInput, pdInputOutput]) and
        (DataSet.MasterDataLink.DataSource.DataSet.FindField(DataSet.Parameters[I].Name) <> nil) then
        MasterFieldList := MasterFieldList + DataSet.Parameters[I].Name + ';';
    DataSet.MasterFields := Copy(MasterFieldList, 1, Length(MasterFieldList)-1);
    DataSet.SetParamsFromCursor;
  end;
end;
