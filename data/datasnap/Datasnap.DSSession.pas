...
uses
  ...
  Data.DBXCommon, Data.DbxDataSnap, Data.DBXTransport, Data.DBXJSON,
  Data.DBXMessageHandlerCommon, Data.DBXClientResStrs,
  {$IFDEF CLR}
...
type
  ...
  {$SCOPEDENUMS ON}
  ///  <summary> Lifetime of a use session
  ///  </summary>
  ...
  ///  <summary>TDSSession exception object</summary>
...
{$ENDIF}
  ...
  System.StrUtils, Data.DBXTransportFilter;
