...
procedure JNI_ThrowException(Env: PJNIEnv; MsgException: string);
var
  jc: JNIObject;
  Ptr: TPtrWrapper;
begin
...
function JNI_BytesToJNIByteArray(Env: PJNIEnv; Bytes: TByteArray): JNIByteArray;
var
   len: Cardinal;
...
function JNI_IntegersToJNIIntArray(Env: PJNIEnv; arr: TIntegerArray): JNIIntArray;
var
   len: Cardinal;
