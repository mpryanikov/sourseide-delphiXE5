...
{$ENDIF !NEXTGEN}
    ...
    /// <summary> Returns a JSON pair value based on the pair string part
    ///
    ///  The search is case sensitive and it returns the fist pair
    ///  with string part matching the argument
    ///
    ...
    function GetValue(const PairName: string): TJSONValue;
...
function TJSONObject.GetValue(const PairName: string): TJSONValue;
var
  LPair: TJSONPair;
begin
  LPair := Get(PairName);
