...
uses
  System.Classes, IBHeader, IBExternals, IB, IBDatabase,
...
begin
  ...
  try
    ...
    // We need the strings to be permanent Ansi Strings (TBytes)
    FEvents.Clear;
...
begin
  Parent.FOnEventAlert(Parent,
     TEncoding.ANSI.GetString(Parent.FEvents[((EventGroup * IB_MAX_EVENT_BLOCK) + WhichEvent)]),
