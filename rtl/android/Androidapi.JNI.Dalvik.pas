...
['{C907AADB-131B-49CC-A2F6-03B88756C7AD}']
  {Methods}
  function init(dexPath: JString; optimizedDirectory: JFile; libraryPath: JString; parent: JClassLoader): JBaseDexClassLoader; cdecl;
end;
...
['{9350A960-93CE-4D6C-BD80-650CCC1AFC4C}']
  {Methods}
  function init(dexPath: JString; optimizedDirectory: JString; libraryPath: JString; parent: JClassLoader): JDexClassLoader; cdecl;
end;
