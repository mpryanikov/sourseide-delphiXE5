...
uses
  ...
  System.Generics.Defaults, System.UITypes, FMX.Types, FMX.Surfaces, FMX.Graphics;
...
begin
  if not SameText(FCurrentSettings.Family, Font.Family) or
     not SameValue(FCurrentSettings.Size, Font.Size, Epsilon) or
     (FCurrentSettings.Style <> Font.Style) or
     not SameValue(FCurrentSettings.Scale, Scale, Epsilon) then
  begin
    FreeResource;
