...
{$SCOPEDENUMS ON}
  ...
  TListingTransitionFeature = (EditMode, DeleteButtonSlide);
...
{ Generation tools }
  ...
  TCaretBehavior = (cbDisableCaretInsideWords);
...
type
  TBehaviorClass = class(TInterfacedObject, IStyleBehavior, IDeviceNameBehavior,
...
procedure TBehaviorClass.GetDeviceName(const Context: TFmxObject;
...
procedure TBehaviorClass.GetSystemStyle(const Context: TFmxObject;
...
begin
  ...
  BehaviorServices.AddBehaviorService(IStyleBehavior, BehaviorClass as IStyleBehavior);
  BehaviorServices.AddBehaviorService(IDeviceNameBehavior, BehaviorClass as IDeviceNameBehavior);
  BehaviorServices.AddBehaviorService(IOSVersionForStyleBehavior, BehaviorClass as IOSVersionForStyleBehavior);
end;
