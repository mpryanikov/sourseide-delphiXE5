...
var
  ...
  begin
    ...
    InvokeData.Instance:=Pointer(PInteger(Src-4)^);
    InvokeData.Instance:= (IJava(InvokeData.Instance) as ILocalObject).GetObjectID;
  end;
  ...
  begin
    case InvokeData.RetKind of
      rkObject, rkConstructor:
        begin
          Res := Pointer(PInteger((PByte(SrcParams)-4))^); // r0 -> destination var
  ...
  case InvokeData.MethodType of
    mkObjectMethod:
      begin
        ...
        case InvokeData.RetKind of
          rkBoolean:
            PByte(PResult)^ := JNIEnv^.CallBooleanMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkByte:
            PByte(PResult)^ := JNIEnv^.CallByteMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkChar:
            PChar(PResult)^ := JNIEnv^.CallCharMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkShort:
            PSmallInt(PResult)^ := JNIEnv^.CallShortMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkInt:
            PInteger(PResult)^ := JNIEnv^.CallIntMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkLong:
            PInt64(PResult)^ := JNIEnv^.CallLongMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkFloat:
            PSingle(PResult)^ := JNIEnv^.CallFloatMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkDouble:
            PDouble(PResult)^ := JNIEnv^.CallDoubleMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkVoid:
            JNIEnv^.CallVoidMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          rkObject:
            begin
              AJNIObject := JNIEnv^.CallObjectMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
          ...
          rkInstance:
            begin
              AJNIObject := JNIEnv^.CallObjectMethodA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
              HandleJNIException(JNIEnv);
              WrappedObj := WrapJNIArray(AJNIObject, InvokeData.RetClsID, InvokeData.JavaType);
            end;
          rkConstructor:
            begin
              AJNIObject := JNIEnv^.NewObjectA(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, DstParams);
              HandleJNIException(JNIEnv);
              WrapJNIReturn(AJNIObject, InvokeData.RetClsID, InvokeData.JavaType, WrappedIntf);
            end;
        end;
    ...
    mkPropertySetMethod:
      begin
        ...
        case InvokeData.RetKind of
          rkBoolean:
            JNIEnv^.SetBooleanField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIBoolean(Src)^);
          rkByte:
            JNIEnv^.SetByteField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIByte(Src)^);
          rkChar:
            JNIEnv^.SetCharField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIChar(Src)^);
          rkShort:
            JNIEnv^.SetShortField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIShort(Src)^);
          rkInt:
            JNIEnv^.SetIntField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIInt(Src)^);
          rkLong:
            JNIEnv^.SetLongField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNILong(Src)^);
          rkFloat:
            JNIEnv^.SetFloatField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIFloat(Src)^);
          rkDouble:
            JNIEnv^.SetDoubleField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIDouble(Src)^);
          rkObject:
            begin
              XFormInterface(Src, DstParams);
              JNIEnv^.SetObjectField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID, PJNIObject(DstParams)^);
            end;
        end;
      end;
    ...
    mkPropertyGetMethod:
      begin
        ...
        case InvokeData.RetKind of
          rkBoolean:
            PByte(PResult)^ := JNIEnv^.GetBooleanField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkByte:
            PByte(PResult)^ := JNIEnv^.GetByteField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkChar:
            PChar(PResult)^ := JNIEnv^.GetCharField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkShort:
            PSmallInt(PResult)^ := JNIEnv^.GetShortField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkInt:
            PInteger(PResult)^ := JNIEnv^.GetIntField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkLong:
            PInt64(PResult)^ := JNIEnv^.GetLongField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkFloat:
            PSingle(PResult)^ := JNIEnv^.GetFloatField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkDouble:
            PDouble(PResult)^ := JNIEnv^.GetDoubleField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
          rkObject:
            begin
              AJNIObject := JNIEnv^.GetObjectField(JNIEnv, JNIObject(InvokeData.Instance), InvokeData.MethodID);
              HandleJNIException(JNIEnv);
              WrapJNIReturn(AJNIObject, InvokeData.RetClsID, InvokeData.JavaType, WrappedIntf);
            end;
          rkInstance:
