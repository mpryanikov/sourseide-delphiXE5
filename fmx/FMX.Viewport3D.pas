...
uses
  ...
  FMX.Types3D, FMX.Controls3D, FMX.Objects3D, FMX.Controls, FMX.Forms, FMX.Graphics;
...
begin
  Result := inherited LocalToScreen(P / GetViewportScale);
end;
...
begin
  Result := inherited ScreenToLocal(P) * GetViewportScale;
end;
