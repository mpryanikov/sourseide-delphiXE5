...
uses
  System.Classes, System.Types, System.UITypes, System.Rtti, FMX.Types, FMX.Graphics;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if Assigned(Value) and (Value is TBitmap) then
        begin
    ...
    begin
      ...
      begin
        ...
        if Assigned(WorkBitmap) then
          IBitmapAccess(FAnimationBitmap).BitmapScale := WorkBitmap.BitmapScale;

        SourceBitmap := FAnimationBitmap.ResourceBitmap;
        if not Assigned(SourceBitmap) then
          SourceBitmap := FAnimationBitmap;

        if Assigned(WorkBitmap) and not (SourceBitmap.IsEmpty) then
        begin
          ...
          try
            ...
            WorkBitmap.Canvas.DrawBitmap(SourceBitmap,
              RectF(LeftPos, TopPos, LeftPos + WorkBitmap.Width, TopPos + WorkBitmap.Height),
              RectF(0, 0, WorkBitmap.Width / WorkBitmap.BitmapScale, WorkBitmap.Height / WorkBitmap.BitmapScale), 1);
          finally
