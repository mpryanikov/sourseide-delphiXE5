...
function DBXLoader_GetDriver(Count: TInt32; Names: TWideStringArray;
  ...
  out pDriver: TDBXDriverHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXLoader_GetDriver' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXBase_GetErrorMessageLength(Handle: TDBXCommonHandle; LastErrorCode: TDBXErrorCode;
  out ErrorLen: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXBase_GetErrorMessageLength' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXBase_GetErrorMessage(Handle: TDBXCommonHandle; LastErrorCode: TDBXErrorCode;
  ErrorMessage: TDBXWideStringBuilder): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXBase_GetErrorMessage' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXBase_Close(Handle: TDBXCommonHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXBase_Close' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetString(Handle: TDBXRowHandle; Ordinal: TInt32;
  Value: TDBXAnsiStringBuilder; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetString' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetWideString(Handle: TDBXRowHandle; Ordinal: TInt32;
  Value: TDBXWideStringBuilder; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetWideString' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetBoolean(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: LongBool; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetBoolean' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetUInt8(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: Byte; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetUInt8' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetInt8(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: ShortInt; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetInt8' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetInt16(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: SmallInt; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetInt16' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetInt32(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: LongInt; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetInt32' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetInt64(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: Int64; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetInt64' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetSingle(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: single; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetSingle' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetDouble(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: double; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetDouble' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetBcd(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: TBcd; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetBcd' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetTimeStamp(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: TSQLTimeStamp; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetTimeStamp' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetTimeStampOffset(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: TSQLTimeStampOffset; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetTimeStampOffset' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetTime(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: TDBXTime; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetTime' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetDate(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Value: TDBXDate; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetDate' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetFixedBytes(Handle: TDBXRowHandle; Ordinal: TInt32;
  const Value: array of Byte; ValueOffset: TInt32; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetFixedBytes' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetByteLength(Handle: TDBXRowHandle; Ordinal: TInt32;
  out Length: Int64; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetByteLength' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetBytes(Handle: TDBXRowHandle; Ordinal: TInt32;
  Offset: Int64; Value: array of Byte; ValueOffset, Length: Int64;
  out ReturnLength: Int64; out IsNull: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetBytes' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXRow_GetObjectTypeName(Handle: TDBXRowHandle; Ordinal: TInt32;
  Value: TDBXWideStringBuilder; MaxLength: Integer): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXRow_GetObjectTypeName' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetNull(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetNull' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetString(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; const Value: TDBXAnsiString; Length: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetString' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetWideString(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; const Value: TDBXWideString; Length: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetWideString' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetBoolean(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetBoolean' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetUInt8(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: Byte): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetUInt8' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetInt8(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: ShortInt): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetInt8' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetInt16(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: SmallInt): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetInt16' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetInt32(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: LongInt): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetInt32' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetInt64(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetInt64' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetSingle(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: Single): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetSingle' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetDouble(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: Double): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetDouble' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetBcd(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: TBcd): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetBcd' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetTimeStamp(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; var Value: TSQLTimeStamp): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetTimeStamp' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetTimeStampOffset(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; var Value: TSQLTimeStampOffset): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetTimeStampOffset' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetTime(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: TDBXTime): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetTime' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXWritableRow_SetDate(Handle: TDBXWritableRowHandle;
  Ordinal: TInt32; Value: TDBXDate): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetDate' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};
...
function DBXWritableRow_SetBytes(Handle: TDBXWritableRowHandle;
  ...
  ValueOffset: Int64; Length: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXWritableRow_SetBytes' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXDriver_CreateConnection(Handle: TDBXDriverHandle;
  out pConn: TDBXConnectionHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXDriver_CreateConnection' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXDriver_GetVersion(Handle: TDBXDriverHandle; Version: TDBXWideStringBuilder;
  MaxLength: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXDriver_GetVersion' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_Connect(Handle: TDBXConnectionHandle; Count: TInt32;
  Names, Values: TWideStringArray): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_Connect' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_Disconnect(Handle: TDBXConnectionHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_Disconnect' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_SetCallbackEvent(Handle: TDBXConnectionHandle; CallbackHandle: DBXCallbackHandle;
  CallbackEvent: DBXTraceCallback): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_SetCallbackEvent' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_CreateCommand(Handle: TDBXConnectionHandle; const CommandType: TDBXWideString;
  out pCommand: TDBXCommandHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_CreateCommand' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_BeginTransaction(Handle: TDBXConnectionHandle; out TransactionHandle: TDBXTransactionHandle;
  IsolationLevel: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_BeginTransaction' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_Commit(Handle: TDBXConnectionHandle;
  TransactionHandle: TDBXTransactionHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_Commit' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_Rollback(Handle: TDBXConnectionHandle;
  TransactionHandle: TDBXTransactionHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_Rollback' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_GetIsolation(Handle: TDBXConnectionHandle;
  out IsolationLevel: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_GetIsolation' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXConnection_GetVendorProperty(Handle: TDBXConnectionHandle; Name: TDBXWideString;
  Value: TDBXWideStringBuilder; MaxLength: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXConnection_GetVendorProperty' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_CreateParameterRow(Handle: TDBXCommandHandle;
  out Parameters: TDBXRowHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_CreateParameterRow' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_Prepare(Handle: TDBXCommandHandle;
  const SQL: TDBXWideString; Count: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_Prepare' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_Execute(Handle: TDBXCommandHandle;
  out Reader: TDBXReaderHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_Execute' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_ExecuteImmediate(Handle: TDBXCommandHandle;
  const SQL: TDBXWideString; out Reader: TDBXReaderHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_ExecuteImmediate' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_GetNextReader(Handle: TDBXCommandHandle;
  out Reader: TDBXReaderHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_GetNextReader' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_GetRowsAffected(Handle: TDBXCommandHandle;
  out Rows: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_GetRowsAffected' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_SetMaxBlobSize(Handle: TDBXCommandHandle;
  MaxBlobSize: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_SetMaxBlobSize' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_SetRowSetSize(Handle: TDBXCommandHandle;
  RowSetSize: Int64): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_SetRowSetSize' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXCommand_GetParameterCount(Handle: TDBXCommandHandle;
  out ParameterCount: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_GetParameterCount' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};
...
function DBXCommand_GetParameterType(Handle: TDBXCommandHandle; Ordinal: TInt32;
  ...
  out Scale: TInt32; out Nullable: LongBool): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXCommand_GetParameterType' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};
...
function DBXParameterRow_SetParameterType(Handle: TDBXRowHandle; Ordinal: TInt32;
  ...
  Scale: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXParameterRow_SetParameterType' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXReader_GetColumnCount(Handle: TDBXReaderHandle;
  out ColumnCount: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXReader_GetColumnCount' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};
...
function DBXReader_GetColumnMetadata(Handle: TDBXReaderHandle;
  ...
  out Scale: TInt32; out flags: TInt32): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXReader_GetColumnMetadata' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};

function DBXReader_Next(Handle: TDBXReaderHandle): TDBXErrorCode; cdecl; external 'libsqlib.a' name 'DBXReader_Next' dependency 'ibtogo', {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF};
