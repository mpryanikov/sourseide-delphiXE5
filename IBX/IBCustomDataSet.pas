...
uses
  System.SysUtils, System.Classes, System.Variants, System.Types, IBExternals,
  IB, IBHeader, IBDatabase, IBSQL, Data.Db, IBBlob, Generics.Collections;
...
type
  ...
  private
    ...
    FBlobStreamList: TList<TIBBlobStream>;
...
uses Data.FmtBcd, Data.DBCommon, Data.DBConsts, System.Generics.Collections,
     IBUtils;
...
begin
  ...
  if Result then
//    Value := TEncoding.Unicode.GetString(Buffer);
...
begin
  ...
  FBlobStreamList := TList<TIBBlobStream>.Create;
...
begin
  if (Field.DataType = ftBCD) and (Buffer <> nil) then
  begin
    BCDToCurr(TBitConverter.ToBcd(Buffer), lTempCurr);
