...
uses
  ...
  FMX.TextLayout, FMX.PixelFormats, FMX.Surfaces, FMX.Context.DX10, System.Character, FMX.Graphics;
...
begin
  ...
  begin
    FTarget.SetTransform(D2Matrix(TMatrix.Identity));
    // First clear
