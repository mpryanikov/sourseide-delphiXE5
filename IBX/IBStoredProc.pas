...
uses System.Classes, Data.DB, IB, IBDatabase, IBCustomDataSet, IBHeader;
    ...
    begin
      ...
      for I := 0 to FParams.Count - 1 do
        if (not FParams[I].Bound) and
          ((FParams[I].ParamType = ptInput) or (FParams[I].ParamType =  ptInputOutput)) then
