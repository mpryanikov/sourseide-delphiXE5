...
{$HPPEMIT '#pragma link "Data.Bind.Grid"'}    {Do not Localize}
unit Data.Bind.Grid;
...
function TCustomLinkGridToDataSource.UpdateBufferCount: Boolean;
var
...
procedure TCustomLinkGridToDataSource.SetAutoBufferCount(const Value: Boolean);
begin
