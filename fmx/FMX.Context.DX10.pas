...
uses
  ...
  Winapi.DxgiType, Winapi.DxgiFormat, FMX.Context.DX9, FMX.Canvas.GPU, FMX.Graphics;
        ...
        begin
          ...
          begin
            ...
            Move(PAlphaColorArray(Mapped.pData)[W + (I * (Mapped.RowPitch div 4))],
              PAlphaColorArray(Bits)[I * (Pitch div 4) + ARect.Left], ARect.Width * 4);
          end;
        end;
      finally
        FCopyBuffer.Unmap(0);
...
begin
  ...
  begin
    ...
    try
      ...
      if IndexCount * IndexSize > IBSize then
      begin
        FIB := nil;
        IBSize := IndexCount * IndexSize;
        HR := FSharedDevice.CreateBuffer(TD3D10_BufferDesc.Create(IBSize, D3D10_BIND_INDEX_BUFFER, D3D10_USAGE_DYNAMIC, D3D10_CPU_ACCESS_WRITE), nil, @FIB);
      end;
