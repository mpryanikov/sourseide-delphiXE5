...
{$I FireDAC.inc}
{$IFDEF WIN32}
  {$HPPEMIT '#pragma link "FireDAC.Phys.DataSnapProxyDelphi.obj"'}
{$ELSE}
  {$HPPEMIT '#pragma link "FireDAC.Phys.DataSnapProxyDelphi.o"'}
{$ENDIF}

unit FireDAC.Phys.DataSnapProxyDelphi;
...
begin
  Result.UsesUnits := 'FireDAC.Phys.DataSnapProxyDelphi';
  ...
  Result.Author := 'DA-SOFT'; // do not localize
  Result.Comment := '';
