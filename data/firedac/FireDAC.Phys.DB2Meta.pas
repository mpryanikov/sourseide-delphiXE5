...
type
  ...
  private
    function GetDB2Returning(const AStmt: String;
...
uses
  System.SysUtils,
  FireDAC.Stan.Consts, FireDAC.DatS, FireDAC.Stan.Util;
...
{-------------------------------------------------------------------------------}
function TFDPhysDb2Metadata.GetSelectWithoutFrom: Boolean;
begin
  Result := False;
end;
...
{-------------------------------------------------------------------------------}
function TFDPhysDb2Metadata.InternalEscapeBoolean(
...
{-------------------------------------------------------------------------------}
function TFDPhysDb2CommandGenerator.GetPing: String;
begin
