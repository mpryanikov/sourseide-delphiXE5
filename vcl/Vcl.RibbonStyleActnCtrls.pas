...
begin
  case Element of
    ...
    else if Element = sfBottomFrameDisabled then
    begin

      Canvas.Pen.Width := 1;
      Canvas.Pen.Color := $00999999;
      Canvas.MoveTo(Rect.Left + 6, Rect.Top);
      Canvas.LineTo(Rect.Right - 6, Rect.Top);
      Canvas.MoveTo(Rect.Left + 6, Rect.Top + 1);
      Canvas.LineTo(Rect.Right - 6, Rect.Top + 1);

      Canvas.Pen.Color := $00ABABAB;
      Canvas.MoveTo(Rect.Left + 4, Rect.Top + 2);
      Canvas.LineTo(Rect.Right - 4, Rect.Top + 2);
      Canvas.MoveTo(Rect.Left + 4, Rect.Top + 3);
      Canvas.LineTo(Rect.Right - 4, Rect.Top + 3);

      Canvas.MoveTo(Rect.Left + 4, Rect.Top);
      Canvas.LineTo(Rect.Left + 4, Rect.Top + 2);
      Canvas.MoveTo(Rect.Left + 5, Rect.Top);
      Canvas.LineTo(Rect.Left + 5, Rect.Top + 2);

      Canvas.MoveTo(Rect.Right - 5, Rect.Top);
      Canvas.LineTo(Rect.Right - 5, Rect.Top + 2);
      Canvas.MoveTo(Rect.Right - 6, Rect.Top);
      Canvas.LineTo(Rect.Right - 6, Rect.Top + 2);

      Canvas.Pen.Color := $009F9F9F;
      Canvas.MoveTo(Rect.Left + 2, Rect.Top + 4);
      Canvas.LineTo(Rect.Right - 2, Rect.Top + 4);
      Canvas.MoveTo(Rect.Left + 2, Rect.Top + 5);
      Canvas.LineTo(Rect.Right - 2, Rect.Top + 5);

      Canvas.MoveTo(Rect.Left + 2, Rect.Top);
      Canvas.LineTo(Rect.Left + 2, Rect.Top + 4);
      Canvas.MoveTo(Rect.Left + 3, Rect.Top);
      Canvas.LineTo(Rect.Left + 3, Rect.Top + 4);

      Canvas.MoveTo(Rect.Right - 3, Rect.Top);
      Canvas.LineTo(Rect.Right - 3, Rect.Top + 4);
      Canvas.MoveTo(Rect.Right - 4, Rect.Top);
      Canvas.LineTo(Rect.Right - 4, Rect.Top + 4);

      Canvas.Pen.Color := $00929292;
      Canvas.MoveTo(Rect.Left, Rect.Top + 6);
      Canvas.LineTo(Rect.Right, Rect.Top + 6);
      Canvas.MoveTo(Rect.Left, Rect.Top + 7);
      Canvas.LineTo(Rect.Right, Rect.Top + 7);

      Canvas.MoveTo(Rect.Left, Rect.Top);
      Canvas.LineTo(Rect.Left, Rect.Top + 6);
      Canvas.MoveTo(Rect.Left + 1, Rect.Top);
      Canvas.LineTo(Rect.Left + 1, Rect.Top + 6);

      Canvas.MoveTo(Rect.Right - 1, Rect.Top);
      Canvas.LineTo(Rect.Right - 1, Rect.Top + 6);
      Canvas.MoveTo(Rect.Right - 2, Rect.Top);
      Canvas.LineTo(Rect.Right - 2, Rect.Top + 6);
    end;
  end;
end;
  ...
  case Element of
    srPage:
      begin
        ...
        DrawButton(RibbonSkin.Bitmap, LSrcRect, Canvas, LRect, 3, 3, 255);
      end;
    srBody:
      begin
        LSrcRect := System.Types.Rect(432, 152 + 31, 432 + 3, 152 + 147);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, LRect, 255);
      end;
    srBackground:
      begin
    ...
    srHelp:
      begin
        ...
        LDstRect := System.Types.Rect(LRect.Left, LRect.Top, LRect.Left + 14, LRect.Top + 14);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, LDstRect);
      end;
  end;
end;
  ...
  case Element of
    ...
    sgUpButtonDisabled:
      begin
        ...
        LSrcRect := System.Types.Rect(150, 188, 150 + 5, 188 + 3);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
        Dec(LDstRect.Right, 5);
        Inc(LDstRect.Top, 9);
    ...
    sgDownButton:
      begin
        LSrcRect := System.Types.Rect(202, 432 + 20, 202 + 15, 432 + 40);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
        LSrcRect := System.Types.Rect(144, 192, 144 + 5, 192 + 3);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
    ...
    sgDownButtonHover:
      begin
        LSrcRect := System.Types.Rect(234, 432 + 20, 234 + 15, 432 + 40);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
        LSrcRect := System.Types.Rect(144, 192, 144 + 5, 192 + 3);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
    ...
    sgDownButtonPressed:
      begin
        LSrcRect := System.Types.Rect(250, 432 + 20, 250 + 15, 432 + 40);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
        LSrcRect := System.Types.Rect(144, 192, 144 + 5, 192 + 3);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
    ...
    sgDownButtonDisabled:
      begin
        LSrcRect := System.Types.Rect(218, 432 + 20, 218 + 15, 432 + 40);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
        LSrcRect := System.Types.Rect(150, 192, 150 + 5, 192 + 3);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
        Dec(LDstRect.Right, 5);
        Inc(LDstRect.Top, 9);
    ...
    sgMoreButtonDisabled:
      begin
        LSrcRect := System.Types.Rect(218, 432 + 40, 218 + 15, 432 + 60);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
        LSrcRect := System.Types.Rect(150, 192, 150 + 5, 192 + 1);
        LDstRect := Rect;
        Inc(LDstRect.Left, 5);
        Dec(LDstRect.Right, 5);
        Inc(LDstRect.Top, 7);
...
procedure TRibbonStyleActionBars.DrawElement(Element: TSkinStatusBar;
  Canvas: TCanvas; Rect: TRect; const ADrawGripperSeparator: Boolean);
var
  LSrcRect: TRect;
  LDstRect: TRect;
begin
  case Element of
    ssbrBackground:
      begin
        LSrcRect := System.Types.Rect(196, 160, 196 + 10, 160 + 22);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
      end;
    ssbrNotification:
      begin
        LSrcRect := System.Types.Rect(218, 160, 218 + 8, 160 + 22);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
      end;
    ssbrControl:
      begin
        LSrcRect := System.Types.Rect(206, 160, 206 + 2, 160 + 22);
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, Rect);
      end;
    ssbrGripper:
      begin
        ...
        if ADrawGripperSeparator then
        begin
          LSrcRect := System.Types.Rect(216, 161, 216 + 2, 161 + 21);
          LDstRect := Rect;
          LDstRect.Right := LDstRect.Left + 2;
          Inc(LDstRect.Top);
          DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, LDstRect);
        ...
        LSrcRect := System.Types.Rect(229, 162, 229 + 11, 162 + 11);
        LDstRect := Rect;
        LDstRect.Left := LDstRect.Right - 13;
        LDstRect.Right := LDstRect.Left + 11;
        LDstRect.Top := LDstRect.Bottom - 13;
        LDstRect.Bottom := LDstRect.Top + 11;
        DrawTransparentBitmap(RibbonSkin.Bitmap, LSrcRect, Canvas, LDstRect);
      end;
  end;
end;
...
begin
  ...
  begin
    if AnItem.CommandProperties is TButtonProperties then
    begin
      LBtnProps := TButtonProperties(AnItem.CommandProperties);
      if (LBtnProps.ButtonType in [btDropDown, btSplit]) then
      begin
        if LBtnProps.ButtonType = btDropDown then
          Result := TRibbonDropDownButton
        else
        begin
          if LBtnProps.ButtonSize = bsLarge then
            Result := TRibbonLargeSplitButton
          else
            Result := TRibbonSmallSplitButton
        end;
      end
      else if (LBtnProps.ButtonSize = bsLarge) then
