...
begin
  if TADSConnection(Pointer(iCallbackID)).FAbortRequest then begin
    TADSConnection(Pointer(iCallbackID)).FAbortRequest := False;
    Result := 1;
  end
  else
    Result := 0;
...
{-------------------------------------------------------------------------------}
procedure TADSConnection.EnableAbort;
...
{-------------------------------------------------------------------------------}
procedure TADSConnection.DisableAbort;
...
{-------------------------------------------------------------------------------}
function ADSNativeExceptionLoad(AStorage: TFDStorage): TObject;
begin
