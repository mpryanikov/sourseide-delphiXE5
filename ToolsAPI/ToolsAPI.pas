...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAProject160,0x0E4BFB1D,0x2F3B,0x4CD6,0xA9,0xA2,0x49,0x03,0x71,0x3B,0x59,0xE0);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTASourceEditor,0x4D460588,0x10A60,0x4CAD,0x87,0xE7,0x56,0x54,0x26,0x60,0x73,0xF9);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAIDEInsightService180, 0xD1258D2C,0xDE95,0x4A0A,0x9A,0x7E,0x8C,0x61,0x67,0xF4,0x8B,0x31);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAIDEInsightService, 0x1780CF98,0x614F,0x4BB9,0xA8,0x56,0x3D,0x1D,0x2E,0xA0,0x5A,0x57);'*)
...
{$ENDIF}
  ...
  TOTAProcessType = (optWin32, optOSX32, optWin64, optiOS, optAndroid);
