...
{$I FireDAC.inc}
{$IFDEF WIN32}
  {$HPPEMIT '#pragma link "FireDAC.Stan.Async.obj"'}
{$ELSE}
  {$HPPEMIT '#pragma link "FireDAC.Stan.Async.o"'}
{$ENDIF}
...
{-------------------------------------------------------------------------------}
function TFDStanAsyncExecutor.GetTimeout: LongWord;
begin
  Result := FTimeout;
end;
