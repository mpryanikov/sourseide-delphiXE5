...
begin
  ...
  try
    ...
    if uo_edtUpdateTableName.Enabled and (AOpts is TFDBottomUpdateOptions) then
      uo_edtUpdateTableName.Text := TFDBottomUpdateOptions(AOpts).UpdateTableName;
    if uo_edtKeyFields.Enabled and (AOpts is TFDBottomUpdateOptions) then
    ...
    if uo_edtAutoIncFields.Enabled and (AOpts is TFDBottomUpdateOptions) then
