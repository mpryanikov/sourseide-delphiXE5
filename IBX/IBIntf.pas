...
uses
  {$IFDEF MSWINDOWS} Winapi.Windows, {$ENDIF}  IBHeader, IBInstallHeader,
  IBExternals, System.Generics.Collections, System.Classes;
...
type
  ...
  ['{BCAC76DD-25EB-4261-84FE-0CB3310435E2}']
    ...
    function isc_event_block(event_buffer : PPByte; result_buffer : PPByte;
...
uses System.SysUtils, IB, IBXMLHeader, IBXConst
{$IFDEF ANDROID}
  , Posix.Stdlib,
  Androidapi.IOUtils
{$ENDIF};
...
const
  ...
  function _isc_attach_database(status_vector : PISC_STATUS; db_name_length : Short;
                               db_name : PByte; db_handle : PISC_DB_HANDLE;
                               parm_buffer_length	: Short; parm_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_attach_database' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_gen_sdl(status_vector : PISC_STATUS; isc_array_desc : PISC_ARRAY_DESC;
                                isc_arg3 : PShort; isc_arg4 : PByte; isc_arg5 : PShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_gen_sdl' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_gen_sdl2(status_vector : PISC_STATUS; isc_array_desc : PISC_ARRAY_DESC_V2;
                              isc_arg3 : PShort; isc_arg4 : PByte; isc_arg5 : PShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_gen_sdl2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_get_slice(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                               trans_handle : PISC_TR_HANDLE; array_id : PISC_QUAD;
                               descriptor : PISC_ARRAY_DESC; dest_array : PVoid;
                               slice_length : ISC_LONG): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_get_slice' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_get_slice2(status_vector : PISC_STATUS;
                               db_handle : PISC_DB_HANDLE; trans_handle : PISC_TR_HANDLE;
                               array_id : PISC_QUAD; descriptor : PISC_ARRAY_DESC_V2;
                               dest_array : PVoid; slice_length : ISC_LONG): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_get_slice2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_lookup_bounds(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                   trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                   descriptor : PISC_ARRAY_DESC): ISC_STATUS;  cdecl; external 'libibtogo.a' name PU + 'isc_array_lookup_bounds' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_lookup_bounds2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                    trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                    descriptor : PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_lookup_bounds2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_lookup_desc(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                 trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                 descriptor : PISC_ARRAY_DESC): ISC_STATUS;  cdecl; external 'libibtogo.a' name PU + 'isc_array_lookup_desc' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_lookup_desc2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                  trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                  descriptor : PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_lookup_desc2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_set_desc(status_vector : PISC_STATUS; table_name : PByte;
                              column_name : PByte; sql_dtype, sql_length, sql_dimensions           : PShort;
                               descriptor : PISC_ARRAY_DESC): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_set_desc' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_set_desc2(status_vector : PISC_STATUS; table_name : PByte;
                               column_name : PByte; sql_dtype, sql_length, sql_dimensions : PShort;
                               descriptor : PISC_ARRAY_DESC_V2): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_set_desc2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_put_slice(status_vector : PISC_STATUS; db_handle  : PISC_DB_HANDLE;
                               trans_handle : PISC_TR_HANDLE; array_id : PISC_QUAD;
                               descriptor : PISC_ARRAY_DESC; source_array : PVoid;
                               slice_length : PISC_LONG): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_put_slice' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_array_put_slice2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                               trans_handle : PISC_TR_HANDLE; array_id : PISC_QUAD;
                               descriptor : PISC_ARRAY_DESC_V2; source_array : PVoid;
                               slice_length : PISC_LONG): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_array_put_slice2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_blob_default_desc(descriptor : PISC_BLOB_DESC; table_name : PUChar;
                                 column_name : PUChar); cdecl; external 'libibtogo.a' name PU + 'isc_blob_default_desc' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_blob_default_desc2(descriptor : PISC_BLOB_DESC_V2; table_name : PUChar;
                                  column_name : PUChar); cdecl; external 'libibtogo.a' name PU + 'isc_blob_default_desc2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_gen_bpb(status_vector : PISC_STATUS; to_descriptor, from_descriptor : PISC_BLOB_DESC;
                            bpb_buffer_length : UShort; bpb_buffer : PUChar;
                            bpb_length : PUShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_gen_bpb' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_gen_bpb2(status_vector : PISC_STATUS; to_descriptor, from_descriptor          : PISC_BLOB_DESC_V2;
                             bpb_buffer_length : UShort; bpb_buffer : PUChar;
                             bpb_length  : PUShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_gen_bpb2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_info(status_vector : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE;
                         item_list_buffer_length : Short; item_list_buffer : PByte;
                         result_buffer_length : Short; result_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_info' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_lookup_desc(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                descriptor : PISC_BLOB_DESC; global : PUChar): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_lookup_desc' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_lookup_desc2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                 trans_handle : PISC_TR_HANDLE; table_name, column_name : PByte;
                                 descriptor : PISC_BLOB_DESC_v2; global : PUChar): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_lookup_desc2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_set_desc(status_vector : PISC_STATUS; table_name, column_name : PByte;
                             subtype, charset, segment_size : Short; descriptor : PISC_BLOB_DESC): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_set_desc' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_blob_set_desc2(status_vector : PISC_STATUS; table_name, column_name : PByte;
                              subtype, charset, segment_size : Short;
                              descriptor : PISC_BLOB_DESC_V2): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_blob_set_desc2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_cancel_blob(status_vector  : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_cancel_blob' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_cancel_events(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                             event_id : PISC_LONG): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_cancel_events' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_close_blob(status_vector : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_close_blob' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_commit_retaining(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_commit_retaining' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_commit_transaction(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_commit_transaction' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_create_blob2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                            tran_handle : PISC_TR_HANDLE; blob_handle : PISC_BLOB_HANDLE;
                            blob_id : PISC_QUAD; bpb_length : Short; bpb_address : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_create_blob2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_database_info(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                             item_list_buffer_length : Short; item_list_buffer : PByte;
                               result_buffer_length : Short; result_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_database_info' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_decode_date(ib_date: PISC_QUAD; tm_date: PCTimeStructure); cdecl; external 'libibtogo.a' name PU + 'isc_decode_date' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_decode_sql_date(ib_date: PISC_DATE; tm_date: PCTimeStructure); cdecl; external 'libibtogo.a' name PU + 'isc_decode_sql_date' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_decode_sql_time(ib_time: PISC_TIME; tm_date: PCTimeStructure); cdecl; external 'libibtogo.a' name PU + 'isc_decode_sql_time' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_decode_timestamp(ib_timestamp: PISC_TIMESTAMP; tm_date: PCTimeStructure);  cdecl; external 'libibtogo.a' name PU + 'isc_decode_timestamp' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_detach_database(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_detach_database' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_drop_database(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_drop_database' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_alloc_statement2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                     stmt_handle : PISC_STMT_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_alloc_statement2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_describe(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                             dialect : UShort; xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_describe' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_describe_bind(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                               dialect : UShort; xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_describe_bind' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_execute(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                            stmt_handle : PISC_STMT_HANDLE; dialect : UShort;
                            xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_execute' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_execute2(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                             stmt_handle : PISC_STMT_HANDLE; dialect : UShort;
                             in_xsqlda, out_xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_execute2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_execute_immediate(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                                      tran_handle : PISC_TR_HANDLE; length : UShort;
                                      statement : PByte; dialect : UShort;
                                      xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_execute_immediate' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_fetch(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                          dialect : UShort; xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_fetch' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_free_statement(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                                   options : UShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_free_statement' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_prepare(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                            stmt_handle : PISC_STMT_HANDLE; length : UShort;
                            statement : PByte; dialect : UShort;
                            xsqlda : PXSQLDA): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_prepare' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_set_cursor_name(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                                    cursor_name : PByte; _type : UShort): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_set_cursor_name' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_sql_info(status_vector : PISC_STATUS; stmt_handle : PISC_STMT_HANDLE;
                             item_length : Short; items : PByte; buffer_length : Short;
                             buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_sql_info' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_encode_date(tm_date : PCTimeStructure; ib_date : PISC_QUAD); cdecl; external 'libibtogo.a' name PU + 'isc_encode_date' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_encode_sql_date(tm_date: PCTimeStructure; ib_date : PISC_DATE); cdecl; external 'libibtogo.a' name PU + 'isc_encode_sql_date' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_encode_sql_time(tm_date : PCTimeStructure; ib_time : PISC_TIME); cdecl; external 'libibtogo.a' name PU + 'isc_encode_sql_time' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_encode_timestamp(tm_date : PCTimeStructure; ib_timestamp : PISC_TIMESTAMP); cdecl; external 'libibtogo.a' name PU + 'isc_encode_timestamp' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_event_block(event_buffer : PPByte; result_buffer : PPByte;
                           id_count : UShort; event_list : array of PByte): ISC_LONG; cdecl; external 'libibtogo.a' name PU + 'isc_event_block' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_event_counts(status_vector : PISC_STATUS; buffer_length  : Short;
                             event_buffer : PByte; result_buffer : PByte); cdecl; external 'libibtogo.a' name PU + 'isc_event_counts' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_free(isc_arg1 : PByte): ISC_LONG;  cdecl; external 'libibtogo.a' name PU + 'isc_free' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_get_segment(status_vector : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE;
                           actual_seg_length : PUShort; seg_buffer_length : UShort;
                           seg_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_get_segment' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_interprete(buffer : PByte; status_vector : PPISC_STATUS): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_interprete' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_open_blob2(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                          tran_handle : PISC_TR_HANDLE; blob_handle : PISC_BLOB_HANDLE;
                          blob_id : PISC_QUAD; bpb_length : Short; bpb_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_open_blob2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_prepare_transaction2(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                                    msg_length : Short; msg : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_prepare_transaction2' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_put_segment(status_vector : PISC_STATUS; blob_handle : PISC_BLOB_HANDLE;
                           seg_buffer_len : UShort; seg_buffer : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_put_segment' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_que_events(status_vector : PISC_STATUS; db_handle : PISC_DB_HANDLE;
                          event_id : PISC_LONG; length : Short; event_buffer : PByte;
                          event_function : TISC_CALLBACK; event_function_arg        : PVoid): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_que_events' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_release_savepoint(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                                 tran_name : PByte) : ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_put_segment' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_rollback_retaining(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_rollback_retaining' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_rollback_savepoint(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                                 tran_name : PByte; Option : UShort) : ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_rollback_savepoint' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_rollback_transaction(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_rollback_transaction' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_start_multiple(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                              db_handle_count : Short; teb_vector_address : PISC_TEB): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_start_multiple' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_start_savepoint(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
                               tran_name : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_start_savepoint' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_sqlcode(status_vector : PISC_STATUS): ISC_LONG; cdecl; external 'libibtogo.a' name PU + 'isc_sqlcode' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  procedure _isc_sql_interprete(sqlcode : Short; buffer : PByte;
                               buffer_length : Short);  cdecl; external 'libibtogo.a' name PU + 'isc_sql_interprete' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_vax_integer(buffer : PByte; length : Short): ISC_LONG;  cdecl; external 'libibtogo.a' name PU + 'isc_vax_integer' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  {IB 8.0 functions}
  function _isc_dsql_batch_execute_immed(status_vector : PISC_STATUS;
             db_handle : PISC_DB_HANDLE; tran_handle : PISC_TR_HANDLE;
             Dialect : UShort; no_of_sql : ULong; statement : PPByte;
             rows_affected : PULong) : ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_batch_execute_immed' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_dsql_batch_execute(status_vector : PISC_STATUS; tran_handle : PISC_TR_HANDLE;
             stmt_handle : PISC_STMT_HANDLE; Dialect : UShort;
             insqlda : PXSQLDA; no_of_rows : UShort;
             batch_vars : PXSQLVAR; rows_affected : PULong) : ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_dsql_batch_execute' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}

  // Security Functions
  function _isc_add_user(status_vector : PISC_STATUS; user_sec_data : PUserSecData): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_add_user' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_delete_user(status_vector : PISC_STATUS; user_sec_data : PUserSecData): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_delete_user' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_modify_user(status_vector : PISC_STATUS; user_sec_data : PUserSecData): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_modify_user' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}

  // Other OSRI functions
  function _isc_prepare_transaction(status_vector         : PISC_STATUS;
                               tran_handle               : PISC_TR_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_prepare_transaction' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  // Other Blob functions
  function _BLOB_put(isc_arg1                  : Byte;
           isc_arg2                  : PBSTREAM): Int;  cdecl; external 'libibtogo.a' name PU + 'BLOB_put' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _BLOB_get(isc_arg1                  : PBSTREAM): Int; cdecl; external 'libibtogo.a' name PU + 'BLOB_get' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  ...
  function _isc_service_attach (status_vector             : PISC_STATUS;
                               ...
                               service_handle            : PISC_SVC_HANDLE;
                               isc_arg5                  : UShort;
                               isc_arg6                  : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_service_attach' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_service_detach(status_vector             : PISC_STATUS;
                              service_handle            : PISC_SVC_HANDLE): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_service_detach' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_service_query  (status_vector             : PISC_STATUS;
                               ...
                               isc_arg7                  : PByte;
                               isc_arg8                  : UShort;
                               isc_arg9                  : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_service_query' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_service_start (status_vector             : PISC_STATUS;
                              service_handle            : PISC_SVC_HANDLE;
                              recv_handle               : PISC_SVC_HANDLE;
                              isc_arg4                  : UShort;
                              isc_arg5                  : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_service_start' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  // Client information functions
  procedure _isc_get_client_version(buffer : PByte); cdecl; external 'libibtogo.a' name PU + 'isc_get_client_version' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_get_client_major_version: Integer; cdecl; external 'libibtogo.a' name PU + 'isc_get_client_major_version' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_get_client_minor_version: Integer; cdecl; external 'libibtogo.a' name PU + 'isc_get_client_minor_version' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
  function _isc_transaction_info(status_vector            : PISC_STATUS;
                                tran_handle               : PISC_TR_HANDLE;
                                item_list_buffer_length   : Short;
                                item_list_buffer          : PByte;
                                result_buffer_length      : Short;
                                result_buffer             : PByte): ISC_STATUS; cdecl; external 'libibtogo.a' name PU + 'isc_transaction_info' dependency {$IFDEF IOS}'stdc++'{$ELSE}'stlport_static'{$ENDIF}; {do not localize}
{$ENDIF}
...
{$ENDIF MSWINDOWS}
{$IFDEF MACOS or IB_iOSSimulator}
  if (FIBCrypt = 0) then
...
begin
  ...
  begin
    if LowerCase(Enum.Key) = LowerCase(ALibrary) then
      Result := Enum.Value;
    if ErrorString <> '' then
...
type
  Tsib_event_block = function (EventBuffer : PPByte; ResultBuffer: PPByte; IDCount: UShort;
...
function TIBServerLibrary.isc_event_block(event_buffer : PPByte; result_buffer : PPByte;
				                     id_count : UShort; event_list : array of PByte): ISC_LONG;
begin
