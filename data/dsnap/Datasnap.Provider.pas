...
uses
  System.VarUtils, Datasnap.MidConst, Data.DBConsts, Data.DBCommon, System.TypInfo,
...
begin
  ...
  begin
    ...
    else if (Info.Field is TStringField) then
{$IFNDEF NEXTGEN}
...
begin
  ...
  begin
    ...
    ErrorDS.SetFields([TrueRecNo, Ord(Response)+1, E.Message, '', 1, Variant(LongWord(E.ErrorCode))]);
end;
