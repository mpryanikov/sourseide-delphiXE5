...
uses
  System.SysUtils, System.Classes, System.Types, ToolsAPI,
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPlatform,0x48C2471B,0x92E4,0x4728,0xAE,0xE2,0x6B,0xBE,0xA2,0xCA,0x08,0x60);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTADesignerOSEntry,0x5A4CA4AE,0x19BD,0x4F75,0x9A,0x0A,0x83,0xE5,0x64,0x98,0x56,0x4E);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTADesignerDevice,0x652602C6,0x8AC6,0x4D1F,0xBB,0x70,0xE3,0x45,0xCE,0x5F,0x05,0x55);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPlatformSDKServices,0xDEEC6CA6,0x7027,0x4962,0xA2,0x36,0xA2,0xDF,0x22,0x2F,0x21,0x63};'*)
...
type
  TPlatformSupportsOperation = (psVFSPreProcessor, psMobile, psWindows, psFrameworkCopy, psiOS, psUSBcatch);
  ...
  IOTAPlatform = interface(IOTAPlatform180)
  ['{48C2471B-92E4-4728-AEE2-6BBEA2CA0860}']
    { Return the appropriate output file prefix for this platform given
    the project type string (e.g., 'Library', 'CppConsoleApplication' as
    defined in this file }
  ...
  TOTADevicePlatform = (dpWindows, dpOSX, dpiOS, dpAndroid, dpLinux);
  TOTADeviceFormFactor = (dffDesktop, dffFullScreen, dffPhone, dffTablet);
  TOTAStatusbarPos = (sbpTop, sbpBottom, sbpLeft, sbpRight);

const
  dffPhoneFactors: Set of TOTADeviceFormFactor = [dffPhone, dffTablet];
  dffComputerFactors: Set of TOTADeviceFormFactor = [dffDesktop, dffFullScreen];
...
type
  ...
  IOTADesignerDevice = interface(IInterface)
  ['{652602C6-8AC6-4D1F-BB70-E345CE5F0555}']
    ...
    function GetUserData: Boolean;
    { Determines the device order when is listed }
    ...
    function GetDeviceLayout(Orientation: TOTADeviceOrientation): TOTADeviceLayout;
    { Determines what is the platform of this device }
    function GetDevicePlatform: TOTADevicePlatform;
    ...
    procedure SetDeviceLayout(Orientation: TOTADeviceOrientation; const Value: TOTADeviceLayout);
    procedure SetDevicePlatform(const Value: TOTADevicePlatform);
  ...
  IOTADesignerOSEntry = interface(IInterface)
    ['{5A4CA4AE-19BD-4F75-9A0A-83E56498564E}']
    function GetName: string;
    function GetDisplayname: string;
    function GetVersion: string;
    function GetOSPlatform: TOTADevicePlatform;
    procedure SetName(const Value: string);
    procedure SetDisplayName(const Value: string);
    procedure SetVersion(const Value: string);
    procedure SetOSPlatform(const Value: TOTADevicePlatform);
  ...
  IOTADesignerDeviceServices = interface(IInterface)
    ...
    function GetOSByPlatform(APlatform: TOTADevicePlatform): TOTADesignerOSList;
    { Returns the version of the last OS version used for a determined platform }
    function GetLastOSVersion(APlatform: TOTADevicePlatform): string;
    { Sets the version of the last OS version used for a determined platform }
    procedure SetLastOSVersion(APlatform: TOTADevicePlatform; aVersion: string);
    { Returls true if the platform & OS version pair is valid }
    function ValidateOSVersion(APlatform: TOTADevicePlatform; aVersion: string): Boolean;
  end;
  ...
  IOTARemoteProfileServices = interface(IOTARemoteProfileServices180)
  ...
  IPlatformProvisionInformation = interface//(IPlatformProvisionInformation180)
  ...
  IOTAPlatformSDKAndroid = interface(IOTAPlatformSDK)
    ...
    { Returns the Library path of the SDK }
    ...
    { Sets the Library path of the SDK }
  ...
  { Temporary patch, this will be remove soon}
  TDeviceType = (dtEmulator = 0, dtDevice = 1);
  ...
  IOTAPlatformSDKServices = interface(IOTAPlatformSDKServices180)
