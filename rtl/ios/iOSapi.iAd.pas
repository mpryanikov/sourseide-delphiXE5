...
// iAd String Attributes

function ADBannerContentSizeIdentifierPortrait: Pointer;
function ADBannerContentSizeIdentifierLandscape: Pointer;
function ADBannerContentSizeIdentifier320x50: Pointer;
function ADBannerContentSizeIdentifier480x32: Pointer;
function ADErrorDomain: Pointer;
...
var
  ADBannerContentSizeIdentifierPortrait_: Pointer;
  ADBannerContentSizeIdentifierLandscape_: Pointer;
  ADErrorDomain_: Pointer;
{$ENDREGION}

function GetiAdAttributeObject(Attr: string): Pointer;
var
  iAdLib: HMODULE;
begin
  iAdLib := LoadLibrary(libiAd);
  Result := Pointer(GetProcAddress(iAdLib, PWideChar(Attr))^);
  FreeLibrary(iAdLib);
end;

function ADBannerContentSizeIdentifierPortrait: Pointer;
begin
  if ADBannerContentSizeIdentifierPortrait_ = nil then
    ADBannerContentSizeIdentifierPortrait_ := GetiAdAttributeObject('ADBannerContentSizeIdentifierPortrait');
  Result := ADBannerContentSizeIdentifierPortrait_;
end;

function ADBannerContentSizeIdentifierLandscape: Pointer;
begin
  if ADBannerContentSizeIdentifierLandscape_ = nil then
    ADBannerContentSizeIdentifierLandscape_ := GetiAdAttributeObject('ADBannerContentSizeIdentifierLandscape');
  Result := ADBannerContentSizeIdentifierLandscape_;
end;
...
function ADErrorDomain: Pointer;
begin
  if ADErrorDomain_ = nil then
    ADErrorDomain_ := GetiAdAttributeObject('ADErrorDomain');
  Result := ADErrorDomain_;
end;
